...
class TestPlaneGrid(object):
    ...
    def setup(self):
        ...
        self.plane_grid = PlaneGrid(self.num_pix, numerics.grid_class)
...
class TestSizeablePlaneGrid(object):
    ...
    def setup(self):
        ...
        self.source_plane = SizeablePlaneGrid(self.num_pix, numerics_source.grid_class, 
                                              self.subgrid_res_source, verbose=True)
